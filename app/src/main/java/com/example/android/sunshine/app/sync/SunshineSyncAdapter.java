...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private final WearbleSync wearbleSync;
    ...
    public SunshineSyncAdapter(Context context, boolean autoInitialize) {
        ...
        wearbleSync = new WearbleSync(getContext());
    }
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                updateWidgets();
                updateMuzei();
                updateWearble(cVVector.firstElement());
                notifyWeather();
            }
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Bitmap largeIcon = getBitmap(context, weatherId, resources);
    ...
    public static Bitmap getBitmap(Context context, int weatherId, Resources resources) {
